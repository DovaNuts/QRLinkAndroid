...
class Utility {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q && Build.VERSION.SDK_INT < 30) {
                ...
                contentValues.put(
                    ...
                    "Documents/QRLink/Cache/PDFs/$userEmail"
                )
            ...
            Toast.makeText(context, "Error: No se pudo leer el documento $e", Toast.LENGTH_SHORT).show()
            return ""
        }
    }
    ...
    fun deleteDocument(pdfName: String, userEmail: String, context: Context) {
        ...
        try {
            ...
            // Si tenemos algun error lo mostramos
            Toast.makeText(context, "Error: No se pudo eliminar el documento $e", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    fun downloadDocument(pdfName: String, userEmail: String, context: Context) {
        ...
        try {
            ...
            reference.getFile(finalFile).addOnFailureListener {
                Toast.makeText(
                    context,
                    "Error: No se pudo guardar copia $pdfName",
                    Toast.LENGTH_SHORT
                ).show()
            }
            ...
            // Si tenemos algun error lo mostramos
            Toast.makeText(context, "Error: No se pudo guardar el documento $e", Toast.LENGTH_SHORT).show()
        }
    }
}